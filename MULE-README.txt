...
-----------------------------------------------------------------
./src/test/java/1.8.0/sahi/SahiTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/sahi-functional-test-config.xml

Defines the Mule configuration for the SahiTestCase.java.
...
artifactId=sahi
description=Maven_firstProject for Jenkins Buildpackaging Learning 
muleVersion=3.8.1
packagePath=com/mycompany/mule
forgeProject=n
transports=file,http,https,jdbc,rmi,servlet,jetty,jms,jnp,stdio,tcp,vm
modules=annotationa,jaas,client,boot,json,spring-extras,spring-security,xml,sxc,management,doc,scripting

version=1.0-SNAPSHOT
groupId=1.8.0
basedir=C:\nanu\pcfdev-v0.21.0+PCF1.8.2-windows\mule_maven
--------------------------------------------------------------------